...
int horaAtivo = 0; //9
int horaInativo = 2; //17

unsigned long millisAtual;

//ATIVIDADE DA BOMBA ASPERSORA:
#define RL2 9 
unsigned long intervaloAspercao = 60000; //15MIN(900000)
unsigned long tempoAspercao = 5000; //1.5MIN(90000)
...
#define RL3 10 
long intervaloGotejamento = 120000; //30MIN(1800000)
long tempoGotejamento = 5000; //5MIN(300000)
