...
//ATIVIDADE DA VÁLVULA SOLENÓIDE:
#define RL2 6 
unsigned long intervaloAspercao = 3600000; //1HORA(3600000) - TESTE 60000(1MIN)
unsigned long tempoAspercao = 480000; //8MIN(480000) - TESTE 10000(10SEG)
...
void loop () {
    ...
    if(((now.Hour()) >= horaAtivo) && ((now.Hour()) < horaInativo))
    {
        ...
        //BOMBA ASPERSORA:
        //SE O TEMPO ATUAL MENOS O TEMPO ANTERIOR FOR MAIOR QUE O INTERVALO SETADO PARA ABERTURA DA VÁLVULA:
